    ...
    <div class="card w-3/4 m-10">
        <Card title="Plant Tamogachi" description="A device that treats a plant as a virtual pet"isModalOpen={false}>
            <div class="report">
                ...
                <div class="flex justify-center p-5">
                    <div>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/S3geHCH6NZI?si=5XOA_6Rp4RHyvEdr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                </div>
            </div> 
        </Card>
